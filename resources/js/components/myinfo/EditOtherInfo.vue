        ...
        <tab-content title="Address"  icon="fa fa-home">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                  ...
                  <select v-model="form.barangay_id" class="form-control" name="barangay_id" :class="{ 'is-invalid': form.errors.has('barangay_id') }">
                      <option v-for="barangay in barangay" v-bind:value="barangay.id">{{ barangay.brgyDesc }}</option>
                  </select>
            ...
            <div class="col-md-12">
              <div class="form-group">
                  ...
                  <select v-model="form.citymun_id" class="form-control" name="citymun_id" :class="{ 'is-invalid': form.errors.has('citymun_id') }">
                      <option v-for="citymun in citymun" v-bind:value="citymun.id">{{ citymun.citymunDesc }}</option>
                  </select>
            ...
            <div class="col-md-12">
              <div class="form-group">
                  ...
                  <select v-model="form.province_id" class="form-control" name="province_id" :class="{ 'is-invalid': form.errors.has('province_id') }">
                      <option v-for="province in province" v-bind:value="province.id">{{ province.provDesc }}</option>
                  </select>
            ...
            <div class="col-md-12">
              <div class="form-group">
                  <label>Region</label>
                  <select v-model="form.region_id" class="form-control" name="region_id" :class="{ 'is-invalid': form.errors.has('region_id') }">
                      <option v-for="region in region" v-bind:value="region.id">{{ region.regDesc }}</option>
                  </select>
